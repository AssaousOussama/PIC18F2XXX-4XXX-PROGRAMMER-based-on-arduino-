...
to the app and connect your arduino UNO to your computer then  press OK  the programmer start the programming emediatly 
with a nice progress bar shoing up after the programmer finished programming , a message box will pop up to tell you the programming was done 
